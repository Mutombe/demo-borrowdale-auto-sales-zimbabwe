    ...
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-navy-950">
      ...
      >
        ...
        <div className="overflow-hidden">
          {['DRIVE YOUR', 'DREAM', 'HOME TODAY.'].map((line, i) => (
            <motion.div
              key={line}
              initial={{ y: '110%' }}
              animate={{ y: 0 }}
        ...
        >
          ...
          <p className="text-white/30 text-xs sm:text-sm uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>
            1500+ Cars Sold &middot; 9 Years &middot; Borrowdale Rd
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex absolute right-8 bottom-12 z-20">
        ...
        >
          Borrowdale Auto Sales Zimbabwe &mdash; Harare, Zimbabwe
        </span>
      </div>
    </section>
  );
...
function MarqueeTicker() {
  const items = ['VEHICLE SALES', 'TRADE-INS', 'FINANCING', 'AFTER-SALES', 'CAR SOURCING', 'INSURANCE'];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="flex gap-10 sm:gap-16">
              <div>
                <div className="text-red-600 font-heading text-3xl sm:text-4xl italic leading-none">2015</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Founded</div>
              </div>
              <div>
                <div className="text-red-600 font-heading text-3xl sm:text-4xl italic leading-none">1500+</div>
                <div className="text-white/30 text-[10px] uppercase tracking-[0.2em] mt-2" style={{ fontFamily: 'var(--font-sans)' }}>Served</div>
              </div>
              <div>
                <div className="text-red-600 font-heading text-3xl sm:text-4xl italic leading-none">9+</div>
            ...
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  ...
                  alt="Borrowdale Auto Sales Zimbabwe"
              ...
              <div className="absolute -bottom-8 -left-6 sm:-left-10 w-[45%] overflow-hidden border-4 border-navy-950 shadow-2xl">
                <img
                  src="https://images.unsplash.com/photo-1549317661-bd32c8ce0571?w=600&q=80"
                  alt="Borrowdale Auto Sales Zimbabwe team"
              ...
              <div className="absolute -top-4 -right-4 sm:-right-6 bg-red-600 text-white p-5 sm:p-7 shadow-2xl">
                <div className="text-center">
                  ...
                  <div className="font-heading text-3xl sm:text-4xl italic leading-none mt-1">2015</div>
                </div>
              </div>
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Every Car Inspected', desc: 'Multi-point mechanical inspection on every vehicle before it reaches our lot.' },
    { title: 'Transparent History', desc: 'Full disclosure on every vehicle. No hidden damage, no clocked odometers.' },
    { title: 'Finance Options', desc: 'Partnerships with leading banks for flexible, affordable vehicle financing.' },
    { title: 'After-Sales Support', desc: 'Our relationship continues long after you drive away. Warranty and service support.' },
  ];
    ...
    <section ref={ref} className="bg-navy-900 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1549317661-bd32c8ce0571?w=800&q=80"
              alt="Borrowdale Auto Sales Zimbabwe"
              className="w-full aspect-[4/5] object-cover object-center"
              loading="lazy"
            />
          ...
          >
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-red-600">Borrowdale</span>
            </h2>
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={homeCta.backgroundImage} alt="Borrowdale Auto Sales Zimbabwe" className="w-full h-[130%] object-cover object-center" loading="lazy" />
