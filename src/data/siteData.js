...
const siteData = {
  business: {
    name: "Borrowdale Auto Sales Zimbabwe",
    legalName: "Borrowdale Auto Sales Zimbabwe",
    tagline: "Premium Pre-Owned Vehicles in Borrowdale",
    description: "Borrowdale Auto Sales offers a curated selection of quality pre-owned vehicles in one of Harare's most trusted locations. Every car inspected, every deal transparent, every customer satisfied.",
    phone: "+263 73 405 3347",
    phoneRaw: "+263734053347",
    whatsappNumber: "263734053347",
    email: "sales@borrowdaleauto.co.zw",
    address: "Stand number: 19302, Borrowdale Rd, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 5,
    ratingRounded: 5,
    ...
    cookieConsentKey: "borrowdale-auto-sales-zimbabwe-cookie-consent",
    socialLinks: {
      facebook: "#",
      instagram: "#",
      linkedin: "#",
  ...
  navbar: {
    logoImage: null,
    logoLine1: "Borrowdale",
    logoLine2: "Auto Sales",
  },

  hero: {
    badge: "Borrowdale's Trusted Pre-Owned Vehicle Dealer",
    titleParts: [
      { text: "DRIVE YOUR" },
      { text: "DREAM", highlight: true },
      { text: "HOME TODAY." },
    ],
    subtitle: "Borrowdale Auto Sales offers a curated selection of quality pre-owned vehicles in one of Harare's most trusted locations. Every car inspected, every deal transparent, every customer satisfied.",
  ...
  stats: [
    { number: "1500+", label: "Vehicles Sold" },
  ...
  homeTestimonials: [
    { text: "Bought my first car from Borrowdale Auto Sales Zimbabwe and the experience was incredible. No pressure, honest advice, and they helped me secure financing that fit my budget perfectly.", name: "Wellington Moyo", role: "First-Time Buyer", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "We purchased 8 vehicles for our company fleet and Borrowdale Auto Sales Zimbabwe handled everything -- sourcing, inspection, registration, and delivery. Professional from start to finish.", name: "Chenai Dziva", role: "Fleet Procurement Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "This is my third vehicle from Borrowdale Auto Sales Zimbabwe. I keep coming back because they are honest, their cars are well-inspected, and the after-sales support is genuine.", name: "Tapiwa Gondo", role: "Returning Customer", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Borrowdale Auto Sales has been helping Harare families find their perfect vehicle since 2015. Located on Borrowdale Road, we have built our reputation on honest dealings and quality stock.",
      "Every vehicle on our lot passes a comprehensive multi-point inspection before it reaches our forecourt. Over 1,500 satisfied customers and counting -- because in the car business, trust is everything.",
    ],
    values: [
    ...
    team: [
      { name: "Team Leader", role: "Director", bio: "Leading Borrowdale Auto Sales Zimbabwe with expertise and vision.", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&q=80" },
  ...
  reviews: {
    ...
    items: [
      { text: "Bought my first car from Borrowdale Auto Sales Zimbabwe and the experience was incredible. No pressure, honest advice, and they helped me secure financing that fit my budget perfectly.", name: "Wellington Moyo", role: "First-Time Buyer", rating: 5 },
      { text: "We purchased 8 vehicles for our company fleet and Borrowdale Auto Sales Zimbabwe handled everything -- sourcing, inspection, registration, and delivery. Professional from start to finish.", name: "Chenai Dziva", role: "Fleet Procurement Manager", rating: 5 },
      { text: "This is my third vehicle from Borrowdale Auto Sales Zimbabwe. I keep coming back because they are honest, their cars are well-inspected, and the after-sales support is genuine.", name: "Tapiwa Gondo", role: "Returning Customer", rating: 5 },
      ...
      { text: "The inspection report Borrowdale Auto Sales Zimbabwe provided was more detailed than what I got from a dealership. Impressive transparency.", name: "Simba Karonga", role: "Careful Buyer", rating: 5 },
      { text: "Finance approval came through in 48 hours. Borrowdale Auto Sales Zimbabwe made the entire process painless.", name: "Douglas Mhizha", role: "Finance Client", rating: 5 },
      { text: "Drove 3 hours from Mutare to buy from Borrowdale Auto Sales Zimbabwe because their reputation is that good. Was not disappointed.", name: "Linda Masuku", role: "Out-of-Town Buyer", rating: 5 },
      { text: "Great selection and no high-pressure sales tactics. Borrowdale Auto Sales Zimbabwe let me take my time and make the right decision.", name: "Patrick Makoni", role: "Browser Turned Buyer", rating: 5 },
      { text: "The after-sales follow-up from Borrowdale Auto Sales Zimbabwe was a pleasant surprise. They genuinely care about customer satisfaction.", name: "Angela Mhembere", role: "Satisfied Customer", rating: 5 },
      { text: "Registration, insurance, and financing all handled by Borrowdale Auto Sales Zimbabwe. I just signed and drove away. Incredible service.", name: "Brian Mutema", role: "Complete Package Client", rating: 5 },
    ],
  },
  ...
  contact: {
    ...
    branches: [
      { name: "Main Office", address: "Stand number: 19302, Borrowdale Rd, Harare, Zimbabwe", phone: "+263 73 405 3347", email: "sales@borrowdaleauto.co.zw" },
    ],
  },

  homeCta: {
    title: "YOUR NEXT CAR, STARTS HERE",
    subtitle: "Borrowdale Auto Sales offers a curated selection of quality pre-owned vehicles in one of Harare's most trusted locations. Every car inspected, every deal transparent, every customer satisfied.",
    ctaPrimary: "View Stock",
    ctaSecondary: "Chat on WhatsApp",
    whatsappText: "Hello Borrowdale Auto! I'm interested in viewing your stock.",
    backgroundImage: "https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=1920&q=85",
  },

  footer: {
    description: "Borrowdale Auto Sales offers a curated selection of quality pre-owned vehicles in one of Harare's most trusted locations...",
    copyright: "Borrowdale Auto Sales Zimbabwe",
  },
};
